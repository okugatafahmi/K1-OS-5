                ...
                if (success == 1)
                {
                    ...
                    if (idxTarget == FILE_NOT_FOUND)
                    {
                        ...
                        { // kalau di move di root
                            if (idxSectorSource != 0xFF)
                                writeFile(buffer, filenameSource, &sectors, parentIndexTarget);
                            else
                            {
                        ...
                        {
                            if (idxSectorSource != 0xFF)
                                writeFile(buffer, filenameTarget, &sectors, parentIndexTarget);
                            else
                            {
                    ...
                    else
                    {
                        ...
                        {
                            if (idxSectorSource != 0xFF)
                                writeFile(buffer, filenameTarget, &sectors, (char)idxTarget);
                            else
                            {
                                copyFolder(filenameSource, filenameSource, &success, parentIndexSource, parentIndexTarget);
                            }
