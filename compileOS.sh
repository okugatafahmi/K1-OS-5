...
bcc -ansi -c -o lib/video.o lib/video.c || exit 1
...
ld86 -o mikro -d mikro.o lib_asm.o lib/math.o lib/file.o lib/utils.o lib/teks.o lib/extTeks.o lib/video.o || exit 1
./loadFile mikro
